...
public class PigeonCameraScript3 : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject pigeonCamera;
	...
	void Update(){
		...
		pigeonCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
